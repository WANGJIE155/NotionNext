...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'daisy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '走啊少年，去见一见命运里的风', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-self-delta.vercel.app/', // 网站地址
